...
class Equipe extends MY_Controller
{
    ...
    public function index($pagina = NULL)
    {
        ...
        $this->site_template_load('layout', 'listagem-equipe', $data);
    }
    ...
    {     
        ...
        {					
            ...
            $this->site_template_load('layout', 'interna-equipe', $data);
        }
        else
        {
...
/* Location: ./application/controllers/site/equipe.php */