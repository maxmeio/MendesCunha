 <?php
	...
	$msg_header	=	(is_null($id)) ? "Cadastro de decisoes do sistema" : "Atualização de decisoes do sistema";
	$nameform	=	"decisoes";
...
<div class="row">
	<div class="col-12 grid-margin">
	  <div class="card">
		<div class="card-body">
		  <h4 class="card-title">Decisão</h4>
		  	<?php
			...
			?>
			  <div class="col-md-12">
				<div class="form-group">
				  <label>Empresa</label>
				  <input type="text" name="empresa" value="<?php echo $res['empresa']; ?>" class="form-control" />
				</div>
			  </div>
			  <div class="col-md-12">
				  <div class="form-group">
				  	<label>Pessoa</label>
					<textarea name="pessoa" class="form-control" rows="5"><?php echo htmlspecialchars($res['pessoa']); ?></textarea>
				  </div>
				</div>
			  <div class="col-md-12">
				<div class="form-group">
