...
$lang['valid_emails']   = "O campo %s deve conter endereos de e-mail válidos.";
$lang['valid_url']      = "O campo %s deve conter uma URL válida.";
$lang['valid_ip']       = "O campo %s deve conter um IP válido.";
$lang['min_length']     = "O campo %s deve ter pelo menos %s caracteres em seu comprimento.";
$lang['max_length']     = "O campo %s não pode exceder %s caracteres em seu comprimento.";
$lang['exact_length']   = "O campo %s deve ter exatamente %s caracteres em seu comprimento.";
...
$lang['matches']        = "O campo %s no é igual ao campo %s.";
